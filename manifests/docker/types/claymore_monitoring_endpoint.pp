# minebox::docker::types::claymore_monitoring_endpoint
#
...
#
# @example
#   minebox::docker::types::claymore_monitoring_endpoint { 'namevar': }
define minebox::docker::types::claymore_monitoring_endpoint(
